...
midmarket_companies = [
  ...
  },
  {
    ...
    "owner": "Tutt",
    "hubspot": "",
    "what": "Sand and gravel producer. 1-year contract agreed with $3,750 implementation fee (monthly billing), pending owner Bill Wadley's signature.",
    "connects_with": "Haulers and construction sites (specific connections not yet identified)",
    "main_contacts": [("Bill Wadley", "Owner — on 10-day vacation, pending signature"), ("Ning Xiang", "Operations — delegated by Bill")],
    "tread_features": ["Dispatch", "Fastway Integration (gap — not yet supported)"],
    "personality": "Deal agreed, awaiting owner signature. Operations contact Ning Xiang engaged in owner's absence. Fastway integration gap is an open risk at go-live.",
    "activity": [("May 15", "HeySam", "Contract review — 1-year deal agreed, $3,750 impl. fee; Bill on vacation; Fastway integration gap; beta concerns discussed")],
    "tickets": [],
    "risks": ["Awaiting owner (Bill Wadley) signature. Fastway integration not yet supported."],
    "systems": ["Fastway"],
  },
  {
  ...
  },
  {
    ...
    "owner": "Will Amen",
    "hubspot": "",
    "what": "~90-truck hauler in Orange, TX with 70+ sub-haulers. Dispatch manager (Uni Trucking LLC) took over from Veronica Oct 2025. Deal not yet closed — est. $50–70K/year.",
    "connects_with": "Sub-haulers and construction/aggregate sites in TX",
    "main_contacts": [("Dispatch Manager", "Uni Trucking LLC — attending demo, Veronica's replacement"), ("Mr. George", "Owner — not yet engaged")],
    "tread_features": ["Dispatch", "Sub-hauler Management", "AI Ticket Scanning (interest)", "Axon Accounting Integration (interest)"],
    "personality": "Large operation with sub-hauler complexity. Strong AI ticket scanning interest. Owner not yet engaged in sales process — deal not signed.",
    "activity": [("May 14", "HeySam", "Demo — ~90 trucks, 70+ sub-haulers; AI ticket scanning interest; Axon accounting; owner Mr. George not yet on call")],
    "tickets": [],
    "risks": ["Deal not closed. Owner not yet engaged in sales process."],
    "systems": ["Axon Accounting"],
  },
  {
    "name": "LOBO LOGISTICS",
    "health": "red",
