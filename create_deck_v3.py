...
_MAP_CUSTOMERS = [
    ...
    ("GRANITE CONSTRUCTION (SOCAL)",  33.72, -116.21, "yellow", "mm"),
    ...
    ("HOLCIM - NORTH CENTRAL (FARGO)", 46.88, -96.78, "yellow", "mm"),
    ...
    ("PJ KEATING CO",                 42.60, -71.71,  "yellow", "mm"),
    ...
    ("TRANS-PHOS INC.",               27.90, -82.00,  "yellow", "ent"),
    ("WHITAKER TRANSPORTATION",       41.88, -87.50,  "green",  "ent"),
...
_ENT_LABELS = {
    ...
    "TOMLINSON":                "Tomlinson",
    "TRANS-PHOS INC.":          "Trans-Phos",
    "WHITAKER TRANSPORTATION":  "Whitaker",
    "ZEMBA INC.":               "Zemba",
}
